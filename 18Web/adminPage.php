...
<!-- main card start -->
    <div class="main-card">
        <br>
        <h1>BOOKING <span>DATA</span></h1><br>
        <div class="data-table">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<th>Action</th>"; //menambahkan header action untuk kolom delete
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            ...
                            <button type='submit' name='submit' class='delete-button' onclick='return confirm(\"Are you sure you want to delete this booking?\");'>Delete</button>
                            </form>
                        </td>";
                    echo "</tr>";
                }
