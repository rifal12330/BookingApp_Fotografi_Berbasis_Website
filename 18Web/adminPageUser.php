...
<div class="user-card">
        ...
        <div class="data-table">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<th>Edit</th>"; //menambahkan header action untuk kolom delete
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            ...
                            <button type='submit' name='submit' class='delete-button' onclick='return confirm(\"Are you sure you want to delete this user?\");'>Delete</button>
                            </form>
                        </td>";
                    echo "<td>
                            <form action='adminEditUser.php' method ='POST'>
                            <input type='hidden' name='user_id' value='" . htmlspecialchars($row['user_id']) . "' />
                            <button type='submit' name='submit' class='edit-button' '>Edit</button>
                            </form>
                        </td>";
                    echo "</tr>";
                }
