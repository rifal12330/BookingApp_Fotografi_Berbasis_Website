...
<nav class="navbar">
    ...
    <div class="navbar-extra">
        ...
        <a href="loginRegister.php" id="log-in"><i data-feather="log-in"></i></a>
    </div>
</nav>
<!-- Navbar End -->
...
<section class="hero" id="home">
    <main class="content">
        <h1>PENYEDIA <span>JASA</span></h1>
        <h2>PHOTOGRAPHY & VIDEOGRAPHY</h2>
        <p>"Taking phosphenes, makes ineffable"</p>
        <a href="loginRegister.php" class="cta">Booking Now</a>
    </main>
</section>
<!-- Hero section end-->
...
<section id="ulasan" class="ulasan">
    <h2>Berikan <span>Ulasan</span></h2> 
...
<footer>
    ...
    <div class="credit">
        <p>Created by <a href="">DelapanBelas.Project</a>. | &copy; 2024.</p>
    </div>
</footer>
<!-- footer end -->
