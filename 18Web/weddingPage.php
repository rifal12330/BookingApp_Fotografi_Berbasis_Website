...
<body class="weddingPage">
    <nav class="DelapanBelaswedding" id="WeddingHome" > 
        <main class="wedding">
            <h1>WEDDING <span>PHOTOGRAPHY</span></h1>
        </main>
    </nav>
    ...
    <section class="porto">
        ...
        <div class="videography-container">
            <video controls autoplay loop>
                <source src="vid/portoCinema.mp4">
            </video>
        </div>
    </section>
    ...
    <footer>
        ...
        <div class="credit">
            <p>Created by <a href="">RifalRifdiansyah</a>. | &copy; 2023.</p>
        </div>
    </footer>
    <!-- footer end -->
